        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', marginBottom: '8px' }}>
              <div style={discordBtnStyle}><Lock size={15} /> Lock</div>
              <div style={discordBtnStyle}><Unlock size={15} /> Unlock</div>
              <div style={discordBtnStyle}><EyeOff size={15} /> Hide</div>
              <div style={discordBtnStyle}><Eye size={15} /> Unhide</div>
            </div>

            {/* Row 2: Permit, Invite, Ban, Unban */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', marginBottom: '8px' }}>
              <div style={discordBtnStyle}>🤝 Permit</div>
              <div style={discordBtnStyle}>📩 Invite</div>
              <div style={discordBtnStyle}>⛔ Ban</div>
              <div style={discordBtnStyle}>🛡️ Unban</div>
            </div>

            {/* Row 3: Mute, Unmute, Deafen, Undeaf, Move */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '8px', marginBottom: '8px' }}>
              <div style={discordBtnStyle}>🔇 Mute</div>
              <div style={discordBtnStyle}>🎶 Unmute</div>
              <div style={discordBtnStyle}>🙈 Deafen</div>
              <div style={discordBtnStyle}>👂 Undeaf</div>
              <div style={discordBtnStyle}>🔄 Move</div>
            </div>

            {/* Row 4: Limit, Rename, Bitrate, Region */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', marginBottom: '8px' }}>
              <div style={discordBtnStyle}>👤 Limit</div>
              <div style={discordBtnStyle}>✏️ Rename</div>
              <div style={discordBtnStyle}>📶 Bitrate</div>
              <div style={discordBtnStyle}>🌍 Region</div>
            </div>

            {/* Row 5: Template, Chat, Waiting, Claim, Transfer */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '8px' }}>
              <div style={discordBtnStyle}>📋 Template</div>
              <div style={discordBtnStyle}>💬 Chat</div>
              <div style={discordBtnStyle}>⏳ Waiting</div>
              <div style={discordBtnStyle}>👑 Claim</div>
              <div style={discordBtnStyle}>⏩ Transfer</div>
            </div>
          </div>
